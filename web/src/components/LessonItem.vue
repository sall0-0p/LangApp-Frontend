<template>
  <a v-if="status === 'active'" :href="lesson.href"
     class="block bg-red-600 p-6 rounded-2xl shadow-xl transition transform hover:-translate-y-1 hover:shadow-2xl">
...
<script setup>
  defineProps({
    lesson: {
      type: Object,
      required: true,
      // e.g., { id: 1, title: 'Lesson 1', subtitle: 'Learn...', href: '#' }
    },
    status: {
